      ...
      >
        {!isSuccess ? (
          <>
            ...
            {hasSubmitted && (
              <div className="mx-4 md:mx-5 mt-4 p-3 bg-yellow-900/20 border border-yellow-700/40 rounded-xl">
            ...
            {submitError && (
              <div className="mx-4 md:mx-5 mt-4 p-3 bg-red-900/20 border border-red-700/40 rounded-xl">
                <p className="text-red-400 font-body text-sm leading-relaxed">{submitError}</p>
              </div>
            )}
          ...
          <div className="p-8 text-center flex-grow flex flex-col justify-center items-center">
            ...
            <button
              ...
              className="font-display text-[15px] font-[600] tracking-[0.03em] px-8 py-3 rounded-xl bg-primary text-white opacity-80 hover:opacity-100 transition-opacity duration-200"
            >
              Close
            </button>
          </div>

...
function ProjectSidebar({ project, onClose }: any) {
  ...
  <div
    style={{ zIndex: 999 }}
    id="project-sidebar"
    className="fixed top-0 right-0 h-full w-full md:w-1/2 lg:w-2/5 xl:w-1/3 dark:bg-gray-900 dark:text-gray-100 bg-light text-dark overflow-y-scroll overflow-x-hidden"
  >
    <div className="p-6">
      <div className="sticky pt-4 top-0 bg-light dark:bg-gray-900 z-50 flex justify-between items-center w-full border-b border-b-gray-300 pb-3">
